...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{canVibrate: flags, connectionID: $elm$core$Maybe$Nothing, error: $elm$core$Maybe$Nothing, isConnected: false, isLoading: false, recipientID: $elm$core$Maybe$Nothing, senderID: $elm$core$Maybe$Nothing, sending: false, userName: '', usersList: _List_Nil, vibrateSpeed: 300, vibrateSpeedLimit: 600, vibrateSpeedMin: 200},
...
var $author$project$Main$ConnectedPayload = F3(
	function (isConnected, connectionID, users) {
		return {connectionID: connectionID, isConnected: isConnected, users: users};
	});
var $author$project$Main$User = F3(
	function (canVibrate, userName, connectionID) {
		return {canVibrate: canVibrate, connectionID: connectionID, userName: userName};
	});
...
var $author$project$Main$Message = F4(
	function (recipientID, connectionID, vibrateSpeed, vibrate) {
		return {connectionID: connectionID, recipientID: recipientID, vibrate: vibrate, vibrateSpeed: vibrateSpeed};
	});
...
var $author$project$Main$CloseConnection = {$: 'CloseConnection'};
var $author$project$Main$MessageIn = function (a) {
	return {$: 'MessageIn', a: a};
};
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'canVibrate',
							$elm$json$Json$Encode$bool(model.canVibrate))
						]))),
				_Utils_Tuple2(
				'type',
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'recipientID',
							$elm$json$Json$Encode$string(message.recipientID)),
							_Utils_Tuple2(
							'connectionID',
							$elm$json$Json$Encode$string(message.connectionID)),
							_Utils_Tuple2(
							'vibrateSpeed',
							$elm$json$Json$Encode$int(message.vibrateSpeed)),
							_Utils_Tuple2(
							'vibrate',
							$elm$json$Json$Encode$bool(message.vibrate))
						]))),
				_Utils_Tuple2(
				'type',
		...
		while (true) {
			switch (msg.$) {
					...
					if (value.$ === 'Ok') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									connectionID: $elm$core$Maybe$Just(connectedPayload.connectionID),
									isConnected: connectedPayload.isConnected,
									isLoading: !connectedPayload.isConnected,
									usersList: connectedPayload.users
								}),
							$elm$core$Platform$Cmd$none);
					} else {
				...
				case 'MessageOut':
					...
					if (value.$ === 'Ok') {
						var message = value.a;
						var senderID = message.vibrate ? $elm$core$Maybe$Just(message.connectionID) : $elm$core$Maybe$Nothing;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{senderID: senderID, sending: message.vibrate}),
				...
				case 'MessageIn':
					...
					var newModel = _Utils_update(
						model,
						{sending: vibrate});
					var vibrateSpeed = newModel.vibrateSpeed + newModel.vibrateSpeedMin;
					var messageIDs = A3($elm$core$Maybe$map2, $elm$core$Tuple$pair, newModel.recipientID, newModel.connectionID);
					if (messageIDs.$ === 'Just') {
						...
						return _Utils_Tuple2(
							...
							$author$project$Main$messageIn(
								$author$project$Main$encodeMessage(
									A4($author$project$Main$Message, recipientID, connectionID, vibrateSpeed, newModel.sending))));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				case 'InputUserName':
				...
				case 'InputSlider':
					...
					return _Utils_Tuple2(
						...
						$elm$core$Platform$Cmd$none);
				case 'Connect':
					return ($elm$core$String$length(model.userName) > 0) ? _Utils_Tuple2(
						model,
						...
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('You need to enter a username to continue')
							}),
						$elm$core$Platform$Cmd$none);
				case 'Reset':
					var _v5 = $author$project$Main$init(model.canVibrate);
					var newModel = _v5.a;
				...
				case 'SetRecipientID':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								recipientID: $elm$core$Maybe$Just(recipientID)
							}),
						$elm$core$Platform$Cmd$none);
				case 'SendMessage':
...
var $author$project$Main$EndMessage = {$: 'EndMessage'};
var $author$project$Main$InputSlider = function (a) {
	return {$: 'InputSlider', a: a};
};
...
var $author$project$Main$formatVibrateSpeedText = function (_v0) {
	var vibrateSpeed = _v0.vibrateSpeed;
	var vibrateSpeedLimit = _v0.vibrateSpeedLimit;
...
var $author$project$Main$SetRecipientID = function (a) {
	return {$: 'SetRecipientID', a: a};
};
var $elm$html$Html$li = _VirtualDom_node('li');
var $author$project$Main$userListItem = F2(
	function (model, user) {
		var senderID = A2($elm$core$Maybe$withDefault, '', model.senderID);
		var recipientID = A2($elm$core$Maybe$withDefault, '', model.recipientID);
		var connectionID = A2($elm$core$Maybe$withDefault, '', model.connectionID);
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
					...
					$author$project$Main$SetRecipientID(user.connectionID))
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_Utils_eq(connectionID, user.connectionID) ? A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('level-item')
							...
							_List_fromArray(
								[
									_Utils_eq(senderID, user.connectionID) ? A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('level-item')
									...
									_List_fromArray(
										...
										])) : ((model.sending && _Utils_eq(recipientID, user.connectionID)) ? A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('level-item')
																		...
																		[
																			...
																			_List_fromArray(
																				[
																					...
																					$elm$core$String$fromInt(model.vibrateSpeedLimit)),
																					$elm$html$Html$Attributes$value(
																					$elm$core$String$fromInt(model.vibrateSpeedLimit - model.vibrateSpeed))
																				]),
																			_List_Nil),
																			A2(
																			$elm$html$Html$span,
												...
												[
													...
													_List_fromArray(
														[
															...
															_Utils_eq(model.recipientID, $elm$core$Maybe$Nothing)),
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class(
															model.isLoading ? 'button is-success is-loading' : 'button is-success'),
	...
	return {
		body: _List_fromArray(
			[
				...
				$elm$html$Html$main_,
				_List_Nil,
				model.isConnected ? $author$project$Main$mainView(model) : $author$project$Main$startView(model))
			]),
		title: 'Veebrate'
	};
};
